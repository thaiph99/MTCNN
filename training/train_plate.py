...
#rootPath = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../detection"))
#sys.path.insert(1, rootPath)
from tools.tfrecord_plate_reader import read_multi_tfrecords,read_single_tfrecord
from mtcnn_config import config
from mtcnn_plate_model import P_Net, R_Net, O_Net
import cv2
